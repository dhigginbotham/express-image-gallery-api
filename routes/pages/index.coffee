...
app.post "/add", pass.ensureAuthenticated, pass.ensureAdmin, valid.add, nav.render, middle.addPage, scripts.embed, routes.add
app.get "/:slug/edit", pass.ensureAuthenticated, pass.ensureAdmin, scripts.embed, nav.render, middle.findOne, routes.edit
app.post "/:slug/edit", pass.ensureAuthenticated, pass.ensureAdmin, scripts.embed, nav.render, middle.editPage, (req, res) ->
